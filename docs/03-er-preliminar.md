...
- Prenda: Un código identificador para cada prenda asociado a características tales como el tipo de prenda, su talla, temporada en curso, el precio al que se adquirió, el precio al cual se desea ofertar y un precio en caso de que la prenda se remate.
...
No solo es importante reconocer las entidades que participan de este proceso, tampoco basta con destacar sus atributos relevantes, si que también es de suma importancia reconocer como es que se relacionan entre si, si es existe algún tipo de relación. Por lo mismo, a continuación se reconocerá la cardinalidad en la interacción entre entidades:
